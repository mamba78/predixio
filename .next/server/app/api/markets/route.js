  ...
  (e.id = 820),
    ...
    (e.modules = {
      ...
      7039: (e, t, r) => {
        ...
        var i = {};
        r.r(i), r.d(i, { GET: () => u, revalidate: () => l });
        var o = r(3278),
          n = r(5002),
          a = r(4877),
          s = r(1658);
        ...
        async function u() {
          try {
            ...
            if (e.ok) {
              let t = (await e.json()).map((e) => ({
                title: e.question,
                platform: "Polymarket",
                yes_price: (e.yesTokenPrice || 0.5).toFixed(2),
                no_price: (e.noTokenPrice || 0.5).toFixed(2),
                volume: e.volume24Hours || 0,
                category: e.tags?.[0] || "Other",
                link: `https://polymarket.com/event/${e.slug}?ref=predixio`,
              }));
              return s.NextResponse.json(t);
            }
            let t = await fetch(
            ...
            if (t.ok) {
              let e = (await t.json()).data.map((e) => ({
                title: e.question,
                platform: "Polymarket",
                yes_price: Number(
                  e.tokens.find((e) => "Yes" === e.outcome)?.price || 0.5,
                ).toFixed(2),
                no_price: Number(
                  e.tokens.find((e) => "No" === e.outcome)?.price || 0.5,
                ).toFixed(2),
                volume: e.volume24Hours || 0,
                category: e.tags?.[0] || "Other",
                link: `https://polymarket.com/event/${e.slug}?ref=predixio`,
            ...
            throw Error("All APIs failed");
          } catch (e) {
            return (
              console.error("Polymarket API failed:", e),
              s.NextResponse.json([
                {
        ...
        let c = new o.AppRouteRouteModule({
            ...
            resolvedPagePath: "/workspaces/predixio/app/api/markets/route.ts",
          ...
          let [[i, o], ...n] = s(e),
            {
              ...
              partitioned: b,
              priority: g,
            } = Object.fromEntries(n.map(([e, t]) => [e.toLowerCase(), t]));
          return (function (e) {
            let t = {};
        ...
        (() => {
              ...
              226: function (o, n) {
                !(function (a, s) {
                  ...
                  var l = "function",
                    ...
                    J = function (e, t) {
                      for (var r, i, o, n, a, u, d = 0; d < t.length && !a; ) {
                        var p = t[d],
                          h = t[d + 1];
                        for (r = i = 0; r < p.length && !a && p[r]; )
                          if ((a = p[r++].exec(e)))
                            for (o = 0; o < h.length; o++)
                              (u = a[++i]),
                                typeof (n = h[o]) === c && n.length > 0
                                  ? 2 === n.length
                                    ? typeof n[1] == l
                    ...
                    ee = function (e, t) {
                      ...
                      return (
                        ...
                        (this.getCPU = function () {
                          var e = {};
                          return (e[w] = s), J.call(e, i, n.cpu), e;
                        }),
                        ...
                        (this.getEngine = function () {
                          var e = {};
                          return (
                            (e[f] = s), (e[g] = s), J.call(e, i, n.engine), e
                          );
                        }),
                        (this.getOS = function () {
                          var e = {};
                        ...
                        (this.setUA = function (e) {
                          return (
                            (i =
                              typeof e === d && e.length > 350 ? X(e, 350) : e),
                            this
                          );
                        }),
                        this.setUA(i),
                  ...
                  (ee.VERSION = "1.0.35"),
                    (ee.BROWSER = G([f, g, p])),
                    (ee.CPU = G([w])),
                    (ee.DEVICE = G([h, b, m, v, y, k, x, P, _])),
                    (ee.ENGINE = ee.OS = G([f, g])),
                    typeof n !== u
          ...
          function a(e) {
            ...
            var r = (n[e] = { exports: {} }),
              i = !0;
            try {
              o[e].call(r.exports, r, r.exports, a), (i = !1);
            } finally {
              i && delete n[e];
            }
            return r.exports;
  ...
  `);
        ...
        class c {
          constructor(e, t, r) {
            ...
            ("object" == typeof t && "pathname" in t) || "string" == typeof t
              ? ((i = t), (o = r || {}))
              : (o = r || t || {}),
              (this[u] = { url: l(e, i ?? o.base), options: o, basePath: "" }),
              this.analyze();
          }
          analyze() {
            var e, t, r, o, s;
            let l = (0, a.getNextPathnameInfo)(this[u].url.pathname, {
              ...
              c = (0, n.getHostname)(this[u].url, this[u].options.headers);
          ...
          if (e)
            for (let [o, n] of e.entries())
              "set-cookie" === o.toLowerCase()
                ? (r.push(...i(n)), (t[o] = 1 === r.length ? r[0] : r))
                : (t[o] = n);
          return t;
        }
        function n(e) {
      ...
      2150: (e, t, r) => {
        ...
        function a(e, t) {
          ...
          s &&
            (0, n.pathHasPrefix)(c.pathname, s) &&
          ...
          if (l) {
            let e = t.i18nProvider
              ...
              : (0, i.normalizeLocalePath)(c.pathname, l.locales);
            (c.locale = e.detectedLocale),
              ...
              !e.detectedLocale &&
                ...
                (e = t.i18nProvider
                  ...
                  : (0, i.normalizeLocalePath)(d, l.locales)).detectedLocale &&
                (c.locale = e.detectedLocale);
          }
          return c;
        }
